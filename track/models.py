...
class MonthlyEntry(models.Model):
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='monthly_entries')
...
class MonthlyProduct(models.Model):
    monthly_entry = models.ForeignKey(MonthlyEntry, on_delete=models.CASCADE, related_name='products')
...
class MonthlyPayment(models.Model):
    monthly_entry = models.ForeignKey(MonthlyEntry, on_delete=models.CASCADE, related_name='payments')
